...
class ExultAudioDataPackContent extends ExultContent {
    ...
    protected boolean identify(Path location, ArchiveEntry archiveEntry, InputStream inputStream) throws IOException {
        // Nothing to do for the terminal call - we've failed to find a valid audio data pack if we get that far.
        ...
        // If we got this far, we've got a valid match to a previously unmatched file - update our records.
        foundFlag = true;
        ++m_filenamesFound;
