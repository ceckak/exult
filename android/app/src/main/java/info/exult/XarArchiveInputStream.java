...
class XarArchiveInputStream extends ArchiveInputStream {
    ...
    XarArchiveInputStream(InputStream inputStream) {
        ...
        // Awful hack to get access to entry offsets so we can sort the and ensure in-order access from the InputStream.
        // This is needed because the sprylab xar decoder returns the entries in alphabetical order rather than sorting
